...
@Component({
  selector: 'app-maed-update-information',
  templateUrl: './maed-update-information.component.html',
  styleUrls: ['./maed-update-information.component.css']
})
export class MaedUpdateInformationComponent {
